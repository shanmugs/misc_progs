package com.example.springBootBilling.springBootBillingDto;
...
public class ItemDto {
    ...
    */
    public ItemDto(int id, String internalNumber, String glCode,BigDecimal percentage, Integer priceManual,
            Integer hasDecimals, Integer deleted, Integer assetManagementEnabled) {
 this.id = id;
 this.internalNumber = internalNumber;
 this.glCode = glCode;
 this.percentage = percentage;
 ...
 this.assetManagementEnabled = assetManagementEnabled;
    ...
    */
    ...
    public ItemDto(int id, String internalNumber, String glCode, BigDecimal percentage, Integer priceManual,
            Integer deleted, Integer hasDecimals
            ) {
 this.id = id;
 this.internalNumber = internalNumber;
 this.glCode = glCode;
 ...
 this.hasDecimals = hasDecimals;
    ...
    */
    ...
    public ItemDto(int id, String number, String glCode, String description, Integer deleted, Integer priceManual,
    Integer currencyId, BigDecimal price, BigDecimal percentage, Integer orderLineTypeId,
    Integer hasDecimals, Integer assetManagementEnabled , boolean isPercentage) {

this(id, number, glCode, percentage, priceManual, hasDecimals, deleted, assetManagementEnabled);
//setDescription(description);
setCurrencyId(currencyId);
setOrderLineTypeId(orderLineTypeId);
setIsPercentage(isPercentage);
